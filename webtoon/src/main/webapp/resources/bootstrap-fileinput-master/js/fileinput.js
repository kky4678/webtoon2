...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: '파일의 용량 제한은 <b>{maxSize} KB 입니다</b>. <br>현재 파일의 용량 : "{name}" (<b>{size} KB</b>)',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: '총 이미지 파일을 <b>{n}</b>개 올리셨으며 최대 {m}개까지 됩니다.</b>.',
        ...
        msgInvalidFileExtension: '확장자는 "{extensions}"로 제한이 됩니다.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
